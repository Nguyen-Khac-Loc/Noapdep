...
},{}],"scrolltotop.js":[function(require,module,exports) {
"use strict";
...
exports.signup = exports.logout = exports.login = exports.forgotPassword = exports.deleteAccount = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)("error", "Lỗi! Hãy thử lại");
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Cập nhật thành công");
            location.reload();
          }
          _context.next = 11;
          break;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG5kZG5uMzAxMiIsImEiOiJjbHF3MWo3ZDMwMXA0MmtzZ3JldzY4a3lhIn0.cAZlRW_cgF6oGrl157CyEQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/lnddnn3012/clqxe5778011m01qu6dhog6se/draft',
    // style URL
    scrollZoom: false,
  ...
  locations.forEach(function (location) {
    ...
    map.on('click', function (e) {
      new mapboxgl.Popup({
        offset: 30
      }).setLngLat(location.coordinates).setHTML("<p>Ng\xE0y ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map);
    });
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51OV5WXDtJMUZfyWcOuRtt6O8rKemTbLaax24GyBKPcsN3IsFe04TmnoIAJe1FBvk6JTJZY264xoxl3B01kaMWnHX00j2JHfUOm');
...
var deleteAccountBtn = document.querySelector(".btn--delete--user");
var uploadUserPhoto = document.querySelector('.form__upload');
var myReviewsBtn = document.querySelector('.my-reviews');
if (myReviewsBtn) {
  myReviewsBtn.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var root, userId, _yield$axios$get, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return _axios.default.get("/api/users/".concat(userId, "/reviews"));
          case 6:
...
if (uploadUserPhoto) {
  uploadUserPhoto.addEventListener('change', function (e) {
    var previews = document.getElementById('previewimage');
    if (e.target.files.length === 0) previews.innerHTML = '';else {
      ...
      reader.addEventListener('load', function (e) {
        ...
        div.innerHTML = "\t\t\t\n\t\t\t\t<div style=\"display: flex; align-items: center;\">\n\t\t\t\t\t\t<img src=\"".concat(e.target.result, "\" style=\"width: 100px; margin-right: 10px;\">\n\t\t\t\t\t\t<p>").concat(file[0].name, "</p>\t\t\t  \n\t\t\t\t\t</div>");
        previews.append(div);
      });
    }
  });
...
if (scrollToTopBtn) {
  window.onscroll = function () {
    (0, _scrolltotop.scrollFunction)();
  };
  scrollToTopBtn.addEventListener("click", _scrolltotop.scrollToTop);
}
if (mapbox) {
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    (0, _authen.login)(email, password);
  });
}
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _authen.signup)(name, email, password, confirmPassword);
  });
}
if (deleteAccountBtn) deleteAccountBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        deleteAccountBtn.textContent = 'Đang xử lý..';
        _context2.next = 3;
        return (0, _authen.deleteAccount)();
      case 3:
        (0, _alert.showAlert)("success", "Xoá thành công");
        window.setTimeout(function () {
          location.assign("/");
        }, 1000);
      case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return (0, _authen.forgotPassword)(email);
          case 5:
...
if (logoutBtn) logoutBtn.addEventListener("click", _authen.logout);
if (userDataForm) {
  userDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateData.updateData)(form, "info");
  });
}
if (userPasswordForm) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1544" + '/');
